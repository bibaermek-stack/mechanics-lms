...
Жобада ойын сервері жоқ және оны қоятын жер де жоқ: Vercel serverless ортасында тұрақты
процесс жүрмейді. Сондықтан **бөлме — Supabase Realtime арнасы**, ал ойыншылардың бірі
төреші: бірінші қосылған адамның браузері физиканы жүргізіп, күйді 20 Гц жиілікпен
таратады, қалғандары тек өз пәрменін жібереді.

Бұл шешімнің бағасы да ашық айтылуы керек: төреші матчты басқалардан бір кадр бұрын
көреді, ал төреші бөлмеден шықса, бөлме жаңа төреші сайлап, есеп қайта басталады. Бір
кампус желісіндегі сынып үшін бұл өз серверіңді көтеруден әлдеқайда жеңіл.

Хост presence арқылы сайланады (кім бұрын қосылған), сондықтан ешкім оны жарияламайды
және қайта қосылғанда да сол шешім шығады. Дерекқор кестесі қажет емес — тек anon кілт.

**Демо режимде** (Supabase кілттері жоқ) онлайн бөлмелер ашылмайды, ал боттарға қарсы
жаттығу толық жұмыс істейді.
