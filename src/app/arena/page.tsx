      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 rounded-xl2 border border-slate-200 bg-slate-50/70 p-4 dark:border-white/10 dark:bg-white/[0.03]">
          ...
          <div className="text-micro leading-relaxed text-slate-600 dark:text-slate-400">
            <p>
              <strong>Басқару:</strong> толық тізім мен пернелерді өзгерту — алаңның
              астындағы «Басқару» панелінде. Қысқаша: W/A/S/D немесе тілсызбалар —
              жүру, <kbd>Бос орын</kbd> — тебу, <kbd>Shift</kbd> — екпін. Телефонда
              экрандағы пульт шығады.
            </p>
            <p className="mt-1.5">
              <strong>Екпін</strong> — Ньютонның екінші заңы: перне басылып тұрғанда
              қозғаушы күш 1,9 есе артады, сондықтан үдеу a = F/m де сонша артады.
              Бірақ қоры шектеулі: толық қор ≈ 2,6 с жүгіруге жетеді, тоқтап тұрғанда
              ≈ 5,5 с ішінде қалпына келеді. Қор ойыншының айналасындағы сары
              доғадан көрінеді.
            </p>
            <p className="mt-1.5">
              Ойынның физикасы{" "}
